...
### タイトル画面
- 3つの難易度から選択: **Easy** / **Normal** / **Hard**
- キーボード: **矢印↑↓** で選択、**Enter** / **Space** / **数字1-3** で開始
- タッチ: ボタンをタップで開始
- 右上の **Sound ON/OFF** ボタンまたは **M** キーで音量切替（初期状態はOFF）

### デスクトップ（キーボード）
- **矢印キー** で蛇（触手）の方向を操作
- **Space** で一時停止 / 再開
- **Enter** でタイトルに戻る（ゲームオーバー時）

### スマホ・タブレット（タッチ）
- **スワイプ** で方向操作
- 右上の **⏸ボタン** で一時停止 / 再開
- **タップ** でタイトルに戻る（ゲームオーバー時）
...
| 難易度 | 移動速度 | 説明 |
|--------|---------|------|
| Easy | 3 マス/秒 | ゆっくり。初心者向け |
| Normal | 5 マス/秒 | 標準的な速度 |
| Hard | 約 8.5 マス/秒 | 高速。上級者向け |
